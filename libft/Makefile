...
#    Updated: 2020/02/19 13:49:41 by hvuorine         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS= ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	  ft_isprint.c ft_wcount.c ft_itoa.c ft_memalloc.c \
	  ...
	  ft_toupper.c ft_strrchr.c ft_isupper.c ft_islower.c ft_lstdelone.c \
	  ft_lstnew.c
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o \
	   ft_isprint.o ft_wcount.o ft_itoa.o ft_memalloc.o \
	  ...
	  ft_toupper.o ft_strrchr.o ft_isupper.o ft_islower.o ft_lstnew.o \
	  ft_lstdelone.o
INCLUDES=./
